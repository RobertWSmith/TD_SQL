...
SELECT
    ...
    , ZEROIFNULL(CASE 
        WHEN ORD.REJ_REAS_ID > '' AND ORD.ORD_QTY - TOT_DN_QTY > 0
            THEN ORD.ORDER_QTY - TOT_DN_QTY
        ELSE 0
        END) AS CANCEL_QTY
