SELECT
    ...
    , CAST('In Order Detail, Missing Open Order Sched Line' AS VARCHAR(255)) AS TEST_TABLE_NAME
...
SELECT
    ...
    , CAST('In Open Order Sched Line, Missing Order Detail' AS VARCHAR(255)) AS TEST_TABLE_NAME
