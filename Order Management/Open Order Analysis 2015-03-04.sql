...
FROM (
    ...
    -- ORDER / ITEM CREATE DATE SNAPSHOT
    ...
    SELECT
        ...
        , CASE
            ...
            END AS MEAS_DT
        , MEAS_DT - (EXTRACT(DAY FROM MEAS_DT)+1) AS MEAS_MONTH_DT
        , OD.FRST_PLN_GOODS_ISS_DT AS FRDD_FPGI_DT
        , FRDD_FPGI_DT - (EXTRACT(DAY FROM FRDD_FPGI_DT)+1) AS FRDD_FPGI_MONTH_DT
        , OD.FC_PLN_GOODS_ISS_DT AS FCDD_FPGI_DT
        , FCDD_FPGI_DT - (EXTRACT(DAY FROM FCDD_FPGI_DT)+1) AS FCDD_FPGI_MONTH_DT
        ...
        , C.OWN_CUST_ID
        , C.OWN_CUST_NAME
        , CASE WHEN(C.SALES_ORG_CD IN('N301', 'N311', 'N321', 'N307', 'N317', 'N336') OR
               (C.SALES_ORG_CD IN('N303', 'N313', 'N323') AND C.DISTR_CHAN_CD IN('30', '31')))
          THEN('REPL')
          ELSE('OE')
          END AS OE_REPL_IND
    ...
    FROM GDYR_BI_VWS.GDYR_CAL ITM_CAL
        ...
        INNER JOIN NA_VWS.OPEN_ORDER_SCHDLN OOL
            ON ITM_CAL.DAY_DATE BETWEEN OOL.EFF_DT AND OOL.EXP_DT
        ...
        INNER JOIN NA_BI_VWS.ORDER_DETAIL OD
            ...
            AND ITM_CAL.DAY_DATE BETWEEN OD.EFF_DT AND OD.EXP_DT
            AND OD.ORDER_CAT_ID = 'C'
            AND OD.PO_TYPE_ID <> 'RO'
        ...
        LEFT OUTER JOIN (
                ...
                FROM NA_BI_VWS.DELIVERY_DETAIL_CURR DD
                    ...
                    INNER JOIN GDYR_BI_VWS.GDYR_CAL DN_CAL
                        ON DN_CAL.DAY_DATE = DD.DELIV_NOTE_CREA_DT
                ...
                WHERE
                    ...
                    AND DD.DELIV_NOTE_CREA_DT BETWEEN DATE '2015-02-01' AND CURRENT_DATE-1
                    AND DD.ACTL_GOODS_ISS_DT = DD.DELIV_NOTE_CREA_DT
