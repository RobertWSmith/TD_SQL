-- unvalidated -- validate before using
...
SELECT
    ...
    , CASE
        WHEN Q.EXPORT_IND = 'D'
            THEN (CASE
                -- CONSUMER
                WHEN Q.INT_OWN_CUST_ID = '00A0003149' AND Q.PBU_NBR = '01' AND Q.OE_REPL_IND = 'Repl' THEN 1
                WHEN Q.INT_OWN_CUST_ID = '00A0006582' AND Q.PBU_NBR = '01' AND Q.OE_REPL_IND = 'Repl' THEN 2
                WHEN Q.INT_OWN_CUST_ID = '00A0003088' AND Q.PBU_NBR = '01' AND Q.OE_REPL_IND = 'Repl' THEN 3
                WHEN Q.INT_OWN_CUST_ID = '00A0006929' AND Q.PBU_NBR = '01' AND Q.OE_REPL_IND = 'Repl' THEN 4
                WHEN Q.INT_OWN_CUST_ID = '00A0003047' AND Q.PBU_NBR = '01' AND Q.OE_REPL_IND = 'Repl' THEN 5
                WHEN Q.INT_OWN_CUST_ID = '00A0000632' AND Q.PBU_NBR = '01' AND Q.OE_REPL_IND = 'Repl' THEN 6
                WHEN Q.INT_OWN_CUST_ID = '00A0003117' AND Q.PBU_NBR = '01' AND Q.OE_REPL_IND = 'Repl' THEN 7
                WHEN Q.INT_OWN_CUST_ID = '00A0005262' AND Q.PBU_NBR = '01' AND Q.OE_REPL_IND = 'Repl' THEN 8
                WHEN Q.INT_OWN_CUST_ID = '00A0009337' AND Q.PBU_NBR = '01' AND Q.OE_REPL_IND = 'Repl' THEN 9
                WHEN Q.INT_OWN_CUST_ID = '00A0009994' AND Q.PBU_NBR = '01' AND Q.OE_REPL_IND = 'Repl' THEN 10
                WHEN Q.INT_OWN_CUST_ID = '00A0006932' AND Q.PBU_NBR = '01' AND Q.OE_REPL_IND = 'Repl' THEN 11
                WHEN Q.INT_OWN_CUST_ID = '00A0005041' AND Q.PBU_NBR = '01' AND Q.OE_REPL_IND = 'Repl' THEN 12
                -- MAXX REQUESTED CHANGES FOR CONSUMER
                WHEN Q.INT_OWN_CUST_ID = '00A0003158' AND Q.PBU_NBR = '01' AND Q.OE_REPL_IND = 'Repl' THEN 13
                WHEN Q.INT_OWN_CUST_ID = '00A0003085' AND Q.PBU_NBR = '01' AND Q.OE_REPL_IND = 'Repl' THEN 14
                WHEN Q.INT_OWN_CUST_ID = '00A0003084' AND Q.PBU_NBR = '01' AND Q.OE_REPL_IND = 'Repl' THEN 15
                -- COMMERCIAL
                WHEN Q.INT_OWN_CUST_ID = '00A0006677' AND Q.PBU_NBR = '03' AND Q.OE_REPL_IND = 'Repl' THEN 1
                WHEN Q.INT_OWN_CUST_ID = '00A0006582' AND Q.PBU_NBR = '03' AND Q.OE_REPL_IND = 'Repl' THEN 2
                WHEN Q.INT_OWN_CUST_ID = '00A0009337' AND Q.PBU_NBR = '03' AND Q.OE_REPL_IND = 'Repl' THEN 3
                WHEN Q.INT_OWN_CUST_ID = '00A0006090' AND Q.PBU_NBR = '03' AND Q.OE_REPL_IND = 'Repl' THEN 4
                WHEN Q.INT_OWN_CUST_ID = '00A0003047' AND Q.PBU_NBR = '03' AND Q.OE_REPL_IND = 'Repl' THEN 5
                WHEN Q.INT_OWN_CUST_ID = '00A0005262' AND Q.PBU_NBR = '03' AND Q.OE_REPL_IND = 'Repl' THEN 6
                WHEN Q.INT_OWN_CUST_ID = '00A0005037' AND Q.PBU_NBR = '03' AND Q.OE_REPL_IND = 'Repl' THEN 7
                WHEN Q.INT_OWN_CUST_ID = '00A0006024' AND Q.PBU_NBR = '03' AND Q.OE_REPL_IND = 'Repl' THEN 8
                WHEN Q.INT_OWN_CUST_ID = '00A0005041' AND Q.PBU_NBR = '03' AND Q.OE_REPL_IND = 'Repl' THEN 9
                WHEN Q.INT_OWN_CUST_ID = '00A0008463' AND Q.PBU_NBR = '03' AND Q.OE_REPL_IND = 'Repl' THEN 10
                WHEN Q.INT_OWN_CUST_ID = '00A0006691' AND Q.PBU_NBR = '03' AND Q.OE_REPL_IND = 'Repl' THEN 11
                WHEN Q.INT_OWN_CUST_ID = '00A0003117' AND Q.PBU_NBR = '03' AND Q.OE_REPL_IND = 'Repl' THEN 12
                WHEN Q.INT_OWN_CUST_ID = '00A0008485' AND Q.PBU_NBR = '03' AND Q.OE_REPL_IND = 'Repl' THEN 13
                WHEN Q.INT_OWN_CUST_ID = '00A0006054' AND Q.PBU_NBR = '03' AND Q.OE_REPL_IND = 'Repl' THEN 14
                WHEN Q.INT_OWN_CUST_ID = '00A0006199' AND Q.PBU_NBR = '03' AND Q.OE_REPL_IND = 'Repl' THEN 15
                ELSE 17
            END)
        WHEN Q.EXPORT_IND = 'X' AND Q.OE_REPL_IND = 'Repl' THEN 16
        ELSE 17
        END AS OWN_CUST_RNK
    , CASE
        WHEN OWN_CUST_RNK < 16 THEN Q.INT_OWN_CUST_ID
        WHEN OWN_CUST_RNK = 16 THEN 'Export'
        ELSE 'Other'
        END AS OWN_CUST_ID
    , CASE
        WHEN OWN_CUST_RNK < 16 THEN Q.INT_OWN_CUST_NAME
        WHEN OWN_CUST_RNK = 16 THEN 'Export'
        ELSE 'Other'
        END AS OWN_CUST_NAME
    , Q.OE_REPL_IND
    , Q.EXPORT_IND
    , SUM(ZEROIFNULL(Q.ORDER_QTY)) AS ORDER_QTY
    , SUM(ZEROIFNULL(Q.HIT_QTY)) AS HIT_QTY
    , SUM(ZEROIFNULL(Q.ONTIME_QTY)) AS ONTIME_QTY
    , SUM(ZEROIFNULL(Q.RETURN_HIT_QTY)) AS RETURN_HIT_QTY
    , SUM(ZEROIFNULL(Q.CLAIM_HIT_QTY)) AS CLAIM_HIT_QTY
    , SUM(ZEROIFNULL(Q.FREIGHT_POLICY_HIT_QTY)) AS FREIGHT_POLICY_HIT_QTY
    , SUM(ZEROIFNULL(Q.PHYS_LOG_HIT_QTY)) AS PHYS_LOG_HIT_QTY
    , SUM(ZEROIFNULL(Q.MAN_BLK_HIT_QTY)) AS MAN_BLK_HIT_QTY
    , SUM(ZEROIFNULL(Q.CREDIT_HOLD_HIT_QTY)) AS CREDIT_HOLD_HIT_QTY
    , SUM(ZEROIFNULL(Q.NO_STOCK_HIT_QTY)) AS NO_STOCK_HIT_QTY
    , SUM(ZEROIFNULL(Q.CANCEL_HIT_QTY)) AS CANCEL_HIT_QTY
    , SUM(ZEROIFNULL(Q.CUST_GEN_HIT_QTY)) AS CUST_GEN_HIT_QTY
    , SUM(ZEROIFNULL(Q.MAN_REL_CUST_GEN_HIT_QTY)) AS MAN_REL_CUST_GEN_HIT_QTY
    , SUM(ZEROIFNULL(Q.MAN_REL_HIT_QTY)) AS MAN_REL_HIT_QTY
    , SUM(ZEROIFNULL(Q.OTHER_HIT_QTY)) AS OTHER_HIT_QTY
    , SUM(ZEROIFNULL(Q.SUPPLY_HIT_QTY)) AS SUPPLY_HIT_QTY
    , SUM(ZEROIFNULL(Q.POLICY_HIT_QTY)) AS POLICY_HIT_QTY
    , SUM(ZEROIFNULL(Q.TOT_OTHER_HIT_QTY)) AS TOT_OTHER_HIT_QTY
    , CAST(CASE
            WHEN Q.METRIC_TYPE = 'FRDD' AND Q.PBU_NBR = '01'  AND Q.QUARTER = 'Q1' THEN 7.3
            WHEN Q.METRIC_TYPE = 'FRDD' AND Q.PBU_NBR = '01'  AND Q.QUARTER = 'Q2' THEN 7.4
            WHEN Q.METRIC_TYPE = 'FRDD' AND Q.PBU_NBR = '01'  AND Q.QUARTER = 'Q3' THEN 7.6
            WHEN Q.METRIC_TYPE = 'FRDD' AND Q.PBU_NBR = '01'  AND Q.QUARTER = 'Q4' THEN 7.7
            WHEN Q.METRIC_TYPE = 'FRDD' AND Q.PBU_NBR = '03'  AND Q.QUARTER = 'Q1' THEN 7.1
            WHEN Q.METRIC_TYPE = 'FRDD' AND Q.PBU_NBR = '03'  AND Q.QUARTER = 'Q2' THEN 7.5
            WHEN Q.METRIC_TYPE = 'FRDD' AND Q.PBU_NBR = '03'  AND Q.QUARTER = 'Q3' THEN 7.3
            WHEN Q.METRIC_TYPE = 'FRDD' AND Q.PBU_NBR = '03'  AND Q.QUARTER = 'Q4' THEN 7.3
            WHEN Q.METRIC_TYPE = 'FCDD' AND Q.PBU_NBR = '01'  AND Q.QUARTER = 'Q1' THEN 8.6
            WHEN Q.METRIC_TYPE = 'FCDD' AND Q.PBU_NBR = '01'  AND Q.QUARTER = 'Q2' THEN 8.8
            WHEN Q.METRIC_TYPE = 'FCDD' AND Q.PBU_NBR = '01'  AND Q.QUARTER = 'Q3' THEN 9.0
            WHEN Q.METRIC_TYPE = 'FCDD' AND Q.PBU_NBR = '01'  AND Q.QUARTER = 'Q4' THEN 9.0
            WHEN Q.METRIC_TYPE = 'FCDD' AND Q.PBU_NBR = '03'  AND Q.QUARTER = 'Q1' THEN 8.6
            WHEN Q.METRIC_TYPE = 'FCDD' AND Q.PBU_NBR = '03'  AND Q.QUARTER = 'Q2' THEN 8.8
            WHEN Q.METRIC_TYPE = 'FCDD' AND Q.PBU_NBR = '03'  AND Q.QUARTER = 'Q3' THEN 9.0
            WHEN Q.METRIC_TYPE = 'FCDD' AND Q.PBU_NBR = '03'  AND Q.QUARTER = 'Q4' THEN 9.0
            ELSE 0
        END AS DECIMAL(15,3)) AS TARGET_NUMERATOR
    , CAST(10 AS DECIMAL(15,3)) AS TARGET_DENOMINATOR
    , CAST(CASE
        WHEN Q.METRIC_TYPE = 'FRDD' AND Q.PBU_NBR = '01' THEN 7.7
        WHEN Q.METRIC_TYPE = 'FRDD' AND Q.PBU_NBR = '03' THEN 7.3
        WHEN Q.METRIC_TYPE = 'FCDD' THEN 8.9
    ...
    FROM (
        ...
        SELECT
            ...
            , CUST.OWN_CUST_ID AS INT_OWN_CUST_ID
            , CUST.OWN_CUST_NAME AS INT_OWN_CUST_NAME
            , CASE
