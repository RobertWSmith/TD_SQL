SELECT
    ...
    , Q.MATL_ID
    , Q.MATL_DESCR
    , ROW_NUMBER() OVER (PARTITION BY Q.METRIC_TYPE, Q.COMPLETE_MTH, Q.PBU_NBR ORDER BY Q.NS_AND_CNCL_HIT_QTY DESC) AS HIT_RNK
    , Q.PBU_NBR
    , Q.PBU
    , Q.CATEGORY
    , Q.TIER
    , Q.ORDER_QTY
    , SUM(Q.ORDER_QTY) OVER (PARTITION BY Q.METRIC_TYPE, Q.COMPLETE_MTH, Q.PBU_NBR) AS PBU_ORDER_QTY
    , Q.HIT_QTY
    , SUM(Q.HIT_QTY) OVER (PARTITION BY Q.METRIC_TYPE, Q.COMPLETE_MTH, Q.PBU_NBR) AS PBU_HIT_QTY
    , Q.ONTIME_QTY
    , SUM(Q.ONTIME_QTY) OVER (PARTITION BY Q.METRIC_TYPE, Q.COMPLETE_MTH, Q.PBU_NBR) AS PBU_ONTIME_QTY
    
    , Q.MY_NO_STOCK_HIT_QTY AS NO_STOCK_HIT_QTY
    , Q.MY_CANCEL_HIT_QTY AS CANCEL_HIT_QTY
    , Q.NS_AND_CNCL_HIT_QTY
    , SUM(Q.NS_AND_CNCL_HIT_QTY) OVER (PARTITION BY Q.METRIC_TYPE, Q.COMPLETE_MTH, Q.PBU_NBR) AS PBU_NS_AND_CNCL_HIT_QTY
    , Q.NS_AND_CNCL_HIT_QTY / NULLIFZERO(PBU_NS_AND_CNCL_HIT_QTY) AS NS_AND_CNCL_HIT_PCT
...
SELECT
    ...
    , SUM(OTD.NO_STOCK_HIT_QTY) AS MY_NO_STOCK_HIT_QTY
    , SUM(OTD.CANCEL_HIT_QTY) AS MY_CANCEL_HIT_QTY
    , MY_NO_STOCK_HIT_QTY + MY_CANCEL_HIT_QTY AS NS_AND_CNCL_HIT_QTY
