...
/*    SUM( P.FCDD_RETURN_HIT_QTY ) AS FCDD_RETURN_HIT_QTY,
    ...
    SUM( P.FRDD_LATE_QTY ) AS FRDD_LATE_QTY,
    SUM( P.FRDD_ONTIME_QTY ) AS FRDD_ONTIME_QTY,
    P.FRDD_HIT_DESC/*,
...
SELECT
    ...
    CAST( CASE
        WHEN CUST.PRIM_SHIP_FACILITY_ID <> ODS.FACILITY_ID
            THEN 'Not Primary'
        ELSE 'Primary'
    END AS VARCHAR(20) ) AS PRIMARY_SHIP_FACILITY_IND,   
    ...
    ZEROIFNULL( POL.CURR_ORD_QTY ) - ZEROIFNULL( POL.PRFCT_ORD_HIT_QTY ) AS FCDD_ONTIME_QTY,
    ZEROIFNULL( POL.PRFCT_ORD_FPDD_HIT_QTY ) AS FCDD_LATE_QTY,
...
WHERE
    ...
    AND POL.CMPL_DT BETWEEN CAST( '2013-12-01' AS DATE ) AND ( CURRENT_DATE - 1 )
