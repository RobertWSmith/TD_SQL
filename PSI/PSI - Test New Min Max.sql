SELECT
    ...
    , CASE
        WHEN MTI.MATL_MIN_INV_RQT_QTY IS NOT NULL
            THEN MTI.MATL_MIN_INV_RQT_QTY
        ELSE INVMM.MATL_MIN_INV_RQT_QTY
        END AS "Min Inventory Rqt Qty"
    , MTI.MATL_CYCL_STK_QTY AS "Cycle Stock Rqt Qty"
    , CASE
        WHEN MTI.MATL_MAX_INV_QTY IS NOT NULL
            THEN MTI.MATL_MAX_INV_QTY
        ELSE INVMM.MATL_MAX_INV_QTY
        END AS "Max Inventory Rqt Qty"
    ...
    LEFT OUTER JOIN (
            ...
            FROM (
                ...
                LEFT OUTER JOIN (
                    ...
                    WHERE
                        CAL.DAY_DATE = CAL.MONTH_DT
                        AND CAL.MONTH_DT BETWEEN CURRENT_DATE-1 AND ADD_MONTHS(CURRENT_DATE-1, 7) - EXTRACT(DAY FROM ADD_MONTHS(CURRENT_DATE-1, 7))
